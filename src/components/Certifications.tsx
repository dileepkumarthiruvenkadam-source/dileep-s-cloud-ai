...
const certifications = [
  ...
  {
    title: 'Introduction to Programming & Problem Solving in Python',
    issuer: 'NPTEL',
    icon: '💻',
  },
];
...
export const Certifications = () => {
  ...
  return (
    <section className="py-24 bg-secondary/20 relative" ref={ref}>
      <div className="absolute inset-0 bg-grid-pattern opacity-20" />
      
      <div className="section-container relative z-10">
        <div className="text-center mb-16">
          <span className="text-primary text-sm font-medium uppercase tracking-wider">Credentials</span>
          ...
          {certifications.map((cert, index) => (
            ...
            >
              <div className="card-glass card-hover p-6 h-full text-center">
                ...
                <h3 className="font-heading font-semibold text-sm leading-tight">{cert.title}</h3>
