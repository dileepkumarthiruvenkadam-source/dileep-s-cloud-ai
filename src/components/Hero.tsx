...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="gradient-orb gradient-orb-primary w-[500px] h-[500px] -top-64 -right-64 animate-pulse-glow" />
      <div className="gradient-orb gradient-orb-secondary w-[400px] h-[400px] -bottom-48 -left-48 animate-pulse-glow animation-delay-500" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <div className="animate-fade-up">
              <span className="inline-block px-4 py-1.5 bg-primary/10 border border-primary/50 text-primary text-sm font-bold uppercase tracking-widest mb-6 clip-corner-sm">
                DevOps & AI Engineer
              </span>
            </div>

            <h1 className="animate-fade-up animation-delay-100 text-4xl sm:text-5xl lg:text-6xl font-bold font-heading leading-tight mb-6 uppercase">
              Building{' '}
              <span className="text-primary text-glow">scalable, automated</span>{' '}
              cloud solutions
            </h1>
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-fade-up">
            <div className="relative">
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-primary/20 blur-3xl animate-pulse-glow" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }} />
              
              {/* Hexagon Container */}
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 animate-float">
                <div 
                  className="absolute inset-0 bg-card border-2 border-primary/50 flex items-center justify-center"
